...
public class ConversorJugada {
	 ...
	 * 
	 * @param textoJugada texto a validar
	 * @param tablero tablero con las figuras colocadas
	 ...
	 * 
	 * @param coordenadas coordenadas en texto Ej: 0a
	...
	private static Celda traducirACelda(String coordenadas, Tablero tablero) {
		try {
			...
			throw new RuntimeException("Error de grave en traducción de coordenadas " + coordenadas, ex);
		}
	}
	 ...
	 * 
	 * @param fila fila
	 * @param tamañoEnFilas tamaño en filas
