...
class ArbitroTest {
    ...
    void registrarJugadoresEnOrden() {
        ArbitroAtariGo arbitro = new ArbitroAtariGo(new Tablero(1,1));
    ...
    void obtenerTablero() {
        ...
        assertEquals(tablero, new ArbitroAtariGo(tablero).obtenerTablero());
    }
    ...
    @Test
    void jugar() {
        ArbitroAtariGo arbitro = new ArbitroAtariGo(new Tablero(2,2));
        arbitro.registrarJugadoresEnOrden("a");
        arbitro.registrarJugadoresEnOrden("b");
    ...
    void esMovimientoLegalSuicida2() {
        ...
        arbitro.jugar(tablero.obtenerCelda(1,3));
        assertFalse(arbitro.esMovimientoLegal(tablero.obtenerCelda(0,1)));
    ...
    void esMovimientoLegalSuicida3() {
        ...
        assertFalse(arbitro.esMovimientoLegal(tablero.obtenerCelda(1,2)));
        arbitro.cambiarTurno();
